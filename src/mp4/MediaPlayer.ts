...
/**
 * 使用MediaPlayer来接管对mp4视频文件的流式播放，整个项目的核心就在这里
 */
class MediaPlayer {
	url: string
	player: Player
	mp4boxfile: MP4File         //这里是MP4文件主体
	mediaSource: MediaSource    //MediaSource官方自带API
	mediaInfo: MoovBoxInfo      //MP4信息文件BOX
	downloader: DownLoader      //下载器
	lastSeekTime: number = 0    //最近搜索时间
	...
	loadFile() {
		...
		/**设置回调函数，
		 * 在请求成功的时候，DownLoader会根据不同情况去调用成功回调函数，失败回调函数，结束回调函数
		 * */
